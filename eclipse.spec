...
Patch31: eclipse-disable-uses-constraints.patch
...
BuildRequires: %{?scl_prefix}glassfish-el-api >= 3.0.1
BuildRequires: %{?scl_prefix}glassfish-el >= 3.0.1
...
Requires: %{?scl_prefix}glassfish-el-api >= 3.0.1
Requires: %{?scl_prefix}glassfish-el >= 3.0.1
...
sed -i -e 's/glassfish-jsp-api\/javax\.servlet\.jsp-api\.jar/glassfish-jsp-api.jar/' \
       ...
       -e '/for SCL_JAVA_DIR/a_f="$(echo $_f | rev | cut -d" " -f1 | rev)"' \
...
%changelog
* Mon Apr 03 2017 Mat Booth <mat.booth@redhat.com> - 1:4.6.3-3.1
