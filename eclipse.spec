...
Patch30: eclipse-disable-uses-constraints.patch
...
BuildRequires: %{?scl_prefix_java_common}junit >= 4.12
BuildRequires: %{?scl_prefix_java_common}hamcrest >= 1.3
...
BuildRequires: %{?scl_prefix}eclipse-ecf-core >= 3.13.3-1
...
Requires: %{?scl_prefix_java_common}ant >= 1.9.6
...
Requires: %{?scl_prefix_java_common}apache-commons-jxpath
...
Requires: %{?scl_prefix}eclipse-ecf-core >= 3.13.3-1
...
%if 0%{?fedora} >= 26
Requires: %{?scl_prefix_java_common}osgi(org.tukaani.xz) >= 1.6
%endif
...
Requires:       %{?scl_prefix_java_common}osgi(org.junit) >= 4.12
Requires:       %{?scl_prefix_java_common}osgi(org.hamcrest.core) >= 1.3
...
install -D eclipse.platform/platform/org.eclipse.platform/eclipse32.png \
    $RPM_BUILD_ROOT/usr/share/icons/hicolor/32x32/apps/%{pkg_name}.png
install -D eclipse.platform/platform/org.eclipse.platform/eclipse48.png \
    $RPM_BUILD_ROOT/usr/share/icons/hicolor/48x48/apps/%{pkg_name}.png
install -D eclipse.platform/platform/org.eclipse.platform/eclipse256.png \
    $RPM_BUILD_ROOT/usr/share/icons/hicolor/256x256/apps/%{pkg_name}.png
install -d $RPM_BUILD_ROOT/usr/share/pixmaps
ln -s /usr/share/icons/hicolor/256x256/apps/%{pkg_name}.png \
    $RPM_BUILD_ROOT/usr/share/pixmaps/%{pkg_name}.png
...
sed -i -e 's/Icon=eclipse/Icon=%{pkg_name}/g' desktopintegration/eclipse.desktop
install -m644 -D desktopintegration/eclipse.desktop $RPM_BUILD_ROOT/usr/share/applications/%{pkg_name}.desktop
desktop-file-validate $RPM_BUILD_ROOT/usr/share/applications/%{pkg_name}.desktop
...
%changelog
* Fri Jan 20 2017 Mat Booth <mat.booth@redhat.com> - 1:4.6.2-4.2
- Re-synchronise with Fedora branch

* Mon Jan 16 2017 Mat Booth <mat.booth@redhat.com> - 1:4.6.2-4.1
